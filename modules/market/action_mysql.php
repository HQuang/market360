...
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_crawler_groups";
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_crawler_items";
...
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_widget(
...
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_facilities(
  id smallint(4) unsigned NOT NULL AUTO_INCREMENT,
  title varchar(255) NOT NULL,
  note text NOT NULL,
  icon varchar(255) NOT NULL,
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_rows(
  ...
  title varchar(255) NOT NULL,
  alias varchar(255) NOT NULL,
  wid varchar(255) NOT NULL COMMENT 'Tiện ích',
  faci varchar(255) NOT NULL COMMENT 'Tiện nghi',
  catid smallint(4) NOT NULL,
  groupid varchar(255) NOT NULL DEFAULT '',
  area_p smallint(4) NOT NULL COMMENT 'Tỉnh',
  area_d smallint(4) unsigned NOT NULL COMMENT 'Huyện',
  area_w smallint(4) unsigned NOT NULL COMMENT 'Xã/Phường',
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_field (
  ...
  show_locations varchar(25) NOT NULL,
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_crawler_groups(
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_crawler_items(
  id mediumint(8) NOT NULL AUTO_INCREMENT,
  title varchar(255) NOT NULL,
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_crawler_rows(
  id int(11) unsigned NOT NULL AUTO_INCREMENT,
  title varchar(255) NOT NULL,
  ...
  applyuserid mediumint(11) unsigned NOT NULL DEFAULT '0' COMMENT 'ID quản trị duyệt',
  status tinyint(1) unsigned NOT NULL DEFAULT '1',
  PRIMARY KEY (id),
  UNIQUE KEY url (url),
