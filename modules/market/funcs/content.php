        ...
        if ($new_id > 0) {
            ...
            if (empty($row['id'])) {
                ...
                if (empty($row['is_queue'])) {
                    $wallet->update($total, 'VND', $user_info['userid'], $mess_);
                }
