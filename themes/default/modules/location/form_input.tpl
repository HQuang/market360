...
$(document).ready(function() {
    ...
    $('#provinceid-{CONFIG.index}').change(function(){
    	...
    	$("[name='address']").val( districtid_text + $( "#provinceid-{CONFIG.index} option:selected" ).text());        
	...
	$('#districtid-{CONFIG.index}').change(function(){
    	...
    	$("[name='address']").val( $( "#districtid-{CONFIG.index} option:selected" ).text() + provinceid_text);
