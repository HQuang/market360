    ...
    <div class="row m-bottom">
        ...
        <div class="col-xs-24 <!-- BEGIN: image1 -->col-sm-12 col-md-12<!-- END: image1 --> <!-- BEGIN: image2 -->col-sm-24 col-md-24<!-- END: image2 -->">
            ...
            <ul class="list-content">
                <li><label><em class="fa fa-folder-open-o">&nbsp;</em>{LANG.cat}</label>: <a href="{DATA.cat_link}" title="{DATA.cat}">{DATA.cat}</a></li>
                <!-- BEGIN: type -->
                <li><label><em class="fa fa-cog">&nbsp;</em>{LANG.type}</label>: {DATA.type}</li>
                <!-- END: type -->
                <!-- BEGIN: location -->
                <li><label><em class="fa fa-map-marker">&nbsp;</em>{LANG.area}</label>: <a href="{DATA.location_link}" title="{DATA.location}">{DATA.location}</a></li>
                <!-- END: location -->
                <!-- BEGIN: price -->
                <li><label><em class="fa fa-money">&nbsp;</em>{LANG.price}</label>: <span class="money">{DATA.price}</span></li>
                <!-- END: price -->
                <!-- BEGIN: field -->
