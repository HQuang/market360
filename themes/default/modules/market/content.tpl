...
<div class="content <!-- BEGIN: popup -->popup<!-- END: popup -->">
    ...
    <form class="form-horizontal" action="{NV_BASE_SITEURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&amp;{NV_NAME_VARIABLE}={MODULE_NAME}&amp;{NV_OP_VARIABLE}={OP}&amp;id={ROW.id}&amp;ispopup={ISPOPUP}&amp;redirect={REDIRECT}" method="post" id="frm-submit" autocomplete="off">
            ...
            <div class="panel-body">
                <div class="row m-bottom">
                    ...
                    <div class="col-xs-24 col-sm-12 col-md-12 form-tooltip">
                        <label><strong>{LANG.contact_email}</strong> <em class="fa fa-question-circle fa-pointer text-info" data-toggle="tooltip" data-original-title="{LANG.contact_email_note}">&nbsp;</em></label> <input class="form-control" type="email" name="contact_email" value="{ROW.contact_email}" id="contact_email" oninvalid="setCustomValidity( nv_email )" />
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-24 col-sm-12 col-md-12">
        ...
        <div class="form-group text-center">
            ...
            <!-- END: fullform -->
            <input type="hidden" name="submit" value="1" /> <input class="btn btn-primary loading" type="submit" value="{LANG.submit}" />
        </div>
    </form>
</div>
