...
<br />
Tin của bạn đăng tại&nbsp;
<strong>{DATA.site_name}</strong>
đã được chúng tôi xem xét, dưới đây là thông tin chi tiết:
<br />
<br />
<p style="line-height: 25px; margin: 0">
    <strong>Tiêu đề tin:</strong> {DATA.title}<br /> <strong>Trạng thái kiểm tra:</strong> {DATA.queue_status}<br />
    <!-- BEGIN: reason -->
...
<br />
<br />
Trên đây là thư tự động thông báo về trạng thái duyệt tin. Vui lòng không trả lời thư này.
<br />
