...
<!-- BEGIN: image_link --><a href="{ROW.link}" title="{ROW.description}"<!-- BEGIN: target --> target="{ROW.target}"<!-- END: target -->><img src="{ROW.image}" title="{ROW.description}" class="container-fluid"></a><!-- END: image_link -->
