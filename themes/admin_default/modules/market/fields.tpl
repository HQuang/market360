...
<form class="form-inline" action="{FORM_ACTION}" method="post" id="ffields" autocomplete="off">
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        {LANG.field_id} <span class="require">*</span>
                    </td>
                    <td>
                        <label> <input class="form-control w100" type="text" value="{DATAFORM.field}" name="field"{DATAFORM.fielddisabled}> <span style="color: #DB4156"><i class="fa fa-warning"></i> {LANG.field_id_note}</span></label>
                    </td>
                </tr>
                <!-- END: field -->
                <tr>
                    <td>
                        {LANG.field_title}<span class="require"> *</span>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        {LANG.template} <span class="require">*</span>
                    </td>
                    <td>
                        <div class="message_body" style="max-height: 150px; overflow: auto">
                            <!-- BEGIN: catid -->
                            <label> <input type="checkbox" value="{CATS.id}" name="templateid[]" class="news_checkbox" {CATS.checked} {CATS.disabled} required> {CATS.title}
                            </label>
                            <!-- END: catid -->
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <textarea cols="60" rows="3" name="description" style="width: 350px; overflow: hidden;" class="form-control">{DATAFORM.description}</textarea>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <span style="color: #DB4156"><i class="fa fa-warning"></i> {LANG.field_type_note}<!-- END: field_type --> {FIELD_TYPE_TEXT} 
                    </td>
                </tr>
                <tr id="editorfields"{DATAFORM.editordisabled}>
                    <td>{LANG.field_size}</td>
                    <td>
                        <span class="text-middle">{LANG.field_width}</span>
                        <input class="form-control" style="width: 100px" type="text" value="{DATAFORM.editor_width}" name="editor_width" maxlength="5">
                        <span class="text-middle">{LANG.field_height}</span>
                        <input class="form-control" style="width: 100px" type="text" value="{DATAFORM.editor_height}" name="editor_height" maxlength="5">
                    </td>
                </tr>
            </tbody>
        </table>
        <table class="table table-striped table-bordered table-hover" id="textfields"{DATAFORM.display_textfields}>
            ...
            <tbody>
                    ...
                    <td>
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tr id="li_{MATCH_TYPE.key}">
                                <td class="w350">
                                    <label for="m_{MATCH_TYPE.key}"> <input type="radio" {MATCH_TYPE.checked} id="m_{MATCH_TYPE.key}" value="{MATCH_TYPE.key}" name="match_type"> {MATCH_TYPE.value}
                                    </label>
                                </td>
                                <td>
                                    <!-- BEGIN: match_input -->
                ...
                <tr>
                    <td>{LANG.field_show_locations}:</td>
                    <td>
                        <!-- BEGIN: field_show_locations -->
                        <label> 
                            <input type="checkbox" value="{SL.id}" name="show_locations[]" {SL.checked}> {SL.title} &nbsp;&nbsp;
                        </label>
                        <!-- END: field_show_locations -->
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <table class="table table-striped table-bordered table-hover" id="datefields"{DATAFORM.display_datefields}>
            ...
            <tbody>
                <tr>
                    <td>{LANG.field_default_value}:</td>
                    <td>
                        <label> <input type="radio" value="1" name="current_date"{DATAFORM.current_date_1}> {LANG.field_current_date}
                        </label><label> <input type="radio" value="0" name="current_date"{DATAFORM.current_date_0}> {LANG.field_default_date}
                        </label>&nbsp;
        ...
        <table class="table table-striped table-bordered table-hover" id="choiceitems"{DATAFORM.display_choiceitems} >
            ...
            <tfoot>
                <tr>
                    <td colspan="4">
                        <input type="button" class="btn btn-primary" value="{LANG.field_add_choice}" onclick="nv_choice_fields_additem();" />
                    </td>
                </tr>
            </tfoot>
            <tbody>
                ...
                <tr class="text-center">
                    ...
                    <td>
                        <input class="form-control validalphanumeric" style="width: 100%" type="text" value="{FIELD_CHOICES.key}" name="field_choice[{FIELD_CHOICES.number}]" />
                    </td>
                    <td>
                        <input class="form-control" style="width: 100%" type="text" value="{FIELD_CHOICES.value}" name="field_choice_text[{FIELD_CHOICES.number}]" />
                    </td>
                    <td>
    ...
    <div class="text-center button_fixed_bottom">
        <input class="btn btn-primary" type="submit" value="{LANG.template_save}" name="submit">
...
<script type="text/javascript">
	...
	function nv_choice_fields_additem() {
		...
		newitem += '	<td>' + items + '</td>';
		newitem += '	<td><input class="form-control validalphanumeric" style="width: 100%" type="text" value="" name="field_choice[' + items + ']"></td>';
		newitem += '	<td><input class="form-control" style="width: 100%" type="text" value="" name="field_choice_text[' + items + ']"></td>';
