    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                <label class="col-sm-3 control-label"><strong>{LANG.config_map_position}</strong></label>
                <div class="col-sm-21">
                    <select name="map_position" class="form-control">
                        <!-- BEGIN: map_position -->
                        <option value="{MAP_POSITION.index}"{MAP_POSITION.selected}>{MAP_POSITION.value}</option>
                        <!-- END: map_position -->
                    </select>
                </div>
            </div>
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="80" class="text-center">{LANG.config_maxpost} <em class="fa fa-question-circle fa-pointer text-info" data-toggle="tooltip" data-original-title="{LANG.config_maxpost_note}">&nbsp;</em></th>
                                        <th width="80" class="text-center">{LANG.config_allow_link}</th>
                                    </tr>
                                </thead>
                                <tbody id="groupconfig">
                                    ...
                                    <tr id="row_{GROUPCONFIG.groupid}">
                                        ...
                                        <td class="text-center"><input type="checkbox" name="grouppostconfig[{GROUPCONFIG.groupid}][allow_link]" value="1" {GROUPCONFIG.ck_allow_link} /></td>
                                    </tr>
                                    <!-- END: groupconfig -->
                                </tbody>
                            </table>
