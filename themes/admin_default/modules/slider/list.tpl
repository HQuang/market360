...
<button data-toggle="tooltip" title="{LANG.content_add}" class="btn btn-success content-add-trigger">
	...
	<div id="content-row-{ROW.id}" class="content-list">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-24">
				<!-- BEGIN: image -->
				<img src="{ROW.image}" alt="{ROW.title}" class="w300 pull-left content-image">
				<!-- END: image -->
			</div>
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-24">
				<div class="pull-right">
					<div class="btn-group">
<a style="display: none;" title="{ROW.status_text}" class="btn btn-sm btn-default content-status ct-status{ROW.status}" data-id="{ROW.id}" data-status="{ROW.status}" href="#"><i class="fa fa-circle"></i></a>
<a title="{GLANG.edit}" data-toggle="tooltip" class="btn btn-primary content-edit" data-id="{ROW.id}" href="#"><i class="fa fa-pencil"></i></a>
<a title="{GLANG.delete}" class="btn btn-danger content-delete" data-id="{ROW.id}" data-toggle="tooltip" data-title="{ROW.title}" href="#"><i class="fa fa-trash-o"></i></a>									
					</div>
				</div>
