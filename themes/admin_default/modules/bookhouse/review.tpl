...
<form>
            ...
            <tbody>
                ...
                <tr id="row_{VIEW.review_id}">
                    <td class="text-center">
                        <input type="checkbox" onclick="nv_UncheckAll(this.form, 'idcheck[]', 'check_all[]', this.checked);" value="{VIEW.review_id}" name="idcheck[]" />
                    </td>
                    <td>
                        <a href="{VIEW.link_bookhouse}" title="{VIEW.title}">{VIEW.title}</a>
                    </td>
                    <td>{VIEW.sender}</td>
    ...
    </select>&nbsp; <input type="button" class="btn btn-primary" onclick="nv_review_action(this.form, '{LANG.prounit_del_no_items}')" value="{LANG.action}" />
</form>
<!-- END: main -->