...
<link type="text/css" href="{NV_BASE_SITEURL}{NV_ASSETS_DIR}/js/jquery-ui/jquery-ui.min.css" rel="stylesheet" />
<form action="{ACTION}" method="POST" name="items" class="form-horizontal" id="frm-submit">
    ...
    <div class="row">
        <div class="col-md-19">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-19 col-md-20">
                            <!-- BEGIN: type -->
                            <label><input class="form-control typeid required" type="radio" name="typeid" id="typeid" value="{TYPE.key}"{TYPE.checked}>{TYPE.title} &nbsp;</label>
                            <!-- END: type -->
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-20">
                            <select name="catid" id="catid" class="form-control sselect2" onchange="nv_bookhouse_cat_change({DATA.id}, $(this).val())">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control price" name="price" id="price" value="{DATA.price}" />
                        </div>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-20">
                            <textarea class="form-control" rows="5" name="hometext" oninput="setCustomValidity('')">{DATA.hometext}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label"><strong>{LANG.items_bodytext}</strong></label>
                        <div class="col-sm-20" name="bodytext">{DATA.bodytext}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group required">{LOCATION}</div>
                    <div class="form-group">
                        <input type="text" class="form-control required" name="address" value="{DATA.address}" placeholder="{LANG.items_address}" />
                    </div>
                    <!-- BEGIN: maps -->
                    <hr />
                    <div class="form-group">
    ...
    <div class="text-center">
        <input type="hidden" name="submit" value="1" /> <input type="submit" name="submit" class="btn btn-primary" value="{LANG.items_submit}" />
    </div>
</form>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#frm-submit').submit(function(e) {
            ...
            $.ajax({
                url : script_name + '?' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=items&add=1&nocache=' + new Date().getTime(),
                type : 'post',
                data : $(this).serialize(),
    ...
    function nv_bookhouse_get_cat(_this, catid) {
        ...
        var price_time = $(".price_time:checked").val();
