    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-18">
                    <input type="number" name="num_item_page" class="form-control" value="{CONFIG.num_item_page}" min="1" />
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="col-sm-6 text-right"><strong>{LANG.review_check}</strong></label>
                <div class="col-sm-18">
                    <label><input type="checkbox" name="review_check" value="1" {CONFIG.ck_review_check} />{LANG.review_check}</label>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-24 col-sm-6">
                            <div style="border: 1px solid #ddd; padding: 10px; height: 200px; overflow: scroll;">
                                <!-- BEGIN: post_groups -->
                                <label class="show"><input title="{OPTION.title}" class="post_groups" type="checkbox" name="post_groups[]" value="{OPTION.value}" {OPTION.checked} />{OPTION.title}</label>
                                <!-- END: post_groups -->
                            </div>
                        </div>
