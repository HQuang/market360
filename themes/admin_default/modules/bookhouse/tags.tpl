...
<div class="well">
    <form class="navbar-form" action="{NV_BASE_ADMINURL}index.php" method="get" onsubmit="return nv_search_tag();">
        {LANG.search_key}: <input class="form-control" id="q" type="text" value="{Q}" maxlength="64" name="q" style="width: 265px" /> <input class="btn btn-primary" type="submit" value="{LANG.search}" /><br /> <br /> <label><em>{LANG.search_note}</em></label>
    </form>
</div>
...
<form action="{NV_BASE_ADMINURL}index.php" method="post">
    ...
    <div class="table-responsive">
        <table id="edit" class="table table-striped table-bordered table-hover">
            ...
            <tfoot>
                <tr>
                    <td class="text-center" colspan="2"><input class="btn btn-primary" name="submit1" type="submit" value="{LANG.items_submit}" /></td>
                </tr>
            </tfoot>
            <tbody>
                <tr>
                    <td class="text-right"><strong>{LANG.alias}: </strong></td>
                    <td><input class="form-control w500" name="alias" id="idalias" type="text" value="{alias}" maxlength="255" /><span class="text-middle">{GLANG.length_characters}: <span id="aliaslength" class="red">0</span>. {GLANG.title_suggest_max}
                    </span></td>
                </tr>
                <tr>
                    <td class="text-right"><strong>{LANG.items_keywords}: </strong></td>
                ...
                <tr>
                    ...
                    <td><textarea class="w500 form-control" id="description" name="description" cols="100" rows="5">{description}</textarea><span class="text-middle">{GLANG.length_characters}: <span id="descriptionlength" class="red">0</span>. {GLANG.description_suggest_max}
                    </span></td>
                </tr>
                <tr>
