...
<form method="post" enctype="multipart/form-data" action="">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                <!-- BEGIN: admin_module --> <label><input name="admin_module" value="{ADMIN_MODULE.value}" type="radio"{ADMIN_MODULE.checked}>{ADMIN_MODULE.text}</label>&nbsp;&nbsp;&nbsp; <!-- END: admin_module -->
            </td>
        </tr>
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><input type="checkbox" name="add_item[]" value="{CONTENT.provinceid}"{CONTENT.checked_add_item}></td>
                                <td class="text-center"><input type="checkbox" name="app_item[]" value="{CONTENT.provinceid}"{CONTENT.checked_app_item}></td>
                                <!--
                            <td class="text-center">
                                <input type="checkbox" name="pub_item[]" value="{CONTENT.provinceid}"{CONTENT.checked_pub_item}></td>
                            -->
                                <td class="text-center"><input type="checkbox" name="edit_item[]" value="{CONTENT.provinceid}"{CONTENT.checked_edit_item}></td>
                                <td class="text-center"><input type="checkbox" name="del_item[]" value="{CONTENT.provinceid}"{CONTENT.checked_del_item}></td>
                            </tr>
                            <!-- END: province -->
                        </tbody>
                    </table>
        ...
        <tfoot>
            <tr>
                <td colspan="2" class="text-center"><input type="submit" value="{LANG.save}" name="submit" class="btn btn-primary"></td>
            </tr>
        </tfoot>
    </table>
</form>
