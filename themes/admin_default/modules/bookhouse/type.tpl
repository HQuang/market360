...
<script type="text/javascript">
    ...
    function nv_get_alias(id) {
        ...
        if (title != '') {
            $.post(nv_base_siteurl + 'index.php?' + nv_lang_variable + '=' + nv_lang_data + '&' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=ajax&nocache=' + new Date().getTime(), 'get_alias_title='+ encodeURIComponent(title), function(res) {
                $("#" + id).val(res);
            });
        }
        return false;
