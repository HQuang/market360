<form action="{USER_LOGIN}" method="post" onsubmit="return login_validForm(this);" autocomplete="off" novalidate>
    <div class="nv-info margin-bottom" data-default="{GLANG.logininfo}"></div>
    <div class="form-detail">
        <div class="form-group loginstep1">
            <div class="input-group">
                <label class="p-l0"><strong>{GLANG.username_email}</strong></label>
        ...
        <div class="form-group loginstep1">
            <div class="input-group w-100">
                <label class="p-l0"><strong>{GLANG.password}</strong></label>
        ...
        <div class="form-group loginCaptcha">
            <div class="middle text-center clearfix">
                ...
                <!-- END: default -->
                <!-- BEGIN: compact -->
                <div class="nv-recaptcha-compact">
                    <div id="{RECAPTCHA_ELEMENT}" data-toggle="recaptcha"></div>
                </div>
                <!-- END: compact -->
        ...
        <div class="text-center margin-bottom-lg">
            ...
            <!-- END: redirect -->
            <button class="bsubmit btn btn-primary w-100" type="submit">{GLANG.loginsubmit}</button>
        </div>
        ...
        <div class="text-center openid-btns clearfix">
            <!-- BEGIN: server -->
            <div class="btn-group m-bottom btn-group-justified">
                <button class="btn openid-{OPENID.server} disabled hidden" type="button" tabindex="-1">
                    <i class="fa fa-fw fa-{OPENID.icon}"></i>
                </button>
        ...
        <!-- END: openid -->
        <p class="nav text-center login-more"><a href="/users/register/">{GLANG.register}</a>  <a href="/users/lostpass/">Bạn quên mật khẩu?</a></p>
    </div>
</form>