...
<div class="centered">
    <div class="login-box">
        <div class="page panel panel-default margin-top-lg box-shadow<!-- BEGIN: not_redirect --> <!-- END: not_redirect -->">
            <div class="panel-body">
                ...
                <div class="text-center" align="center">
                    <img src="{NV_BASE_SITEURL}themes/samhomes/images/logo-2.png" alt="{SITE_NAME}" style="max-height: 90px;">
                </div>
                {FILE "login_form.tpl"}
                <div class="text-center margin-top-lg" id="other_form">
                    <!-- BEGIN: navbar -->
                    <a href="{NAVBAR.href}" class="margin-right-lg"><em class="fa fa-caret-right margin-right-sm"></em>{NAVBAR.title}</a>
                    <!-- END: navbar -->
                </div>
            </div>
        </div>
