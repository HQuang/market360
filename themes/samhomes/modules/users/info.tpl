...
<h2 class="title">{LANG.editinfo_pagetitle}</h2>
<div id="posting_nav">
    <ul>
        <li class="{BASIC_ACTIVE}"><a data-toggle="tab" data-location="{EDITINFO_FORM}/basic" href="#edit_basic" class="hvr-icon-up">
        <i class="fa fa-fire hvr-icon"></i> {LANG.edit_basic}</a></li>
        <!-- BEGIN: edit_avatar -->
        <li class="{AVATAR_ACTIVE}"><a data-toggle="tab" href="#edit_avatar" data-location="{EDITINFO_FORM}/avatar" class="hvr-icon-up"><i class="fa fa-user-circle-o hvr-icon"></i> {LANG.edit_avatar}</a></li>
        <!-- END: edit_avatar -->
        <!-- BEGIN: edit_username -->
        <li class="{USERNAME_ACTIVE}"><a data-toggle="tab" data-location="{EDITINFO_FORM}/username" href="#edit_username" class="hvr-icon-up" ><i class="fa fa-cogs hvr-icon"></i> {LANG.edit_login}</a></li>
        <!-- END: edit_username -->
        <!-- BEGIN: edit_email -->
        <li class="{EMAIL_ACTIVE}"><a data-toggle="tab" data-location="{EDITINFO_FORM}/email" href="#edit_email" class="hvr-icon-up"><i class="fa fa-envelope hvr-icon"></i> {LANG.edit_email}</a></li>
        <!-- END: edit_email -->
        <!-- BEGIN: edit_password -->
        <li class="{PASSWORD_ACTIVE}"><a data-toggle="tab" data-location="{EDITINFO_FORM}/password" href="#edit_password" class="hvr-icon-up"><i class="fa fa-cogs hvr-icon"></i> {LANG.edit_password}</a></li>
        <!-- END: edit_password -->
        <!-- BEGIN: 2step -->
        <li><a href="{URL_2STEP}" class="hvr-icon-up"><i class="fa fa-life-bouy hvr-icon"></i> {LANG.2step_status}</a></li>
        <!-- END: 2step -->
        <!-- BEGIN: edit_question -->
        <li class="{QUESTION_ACTIVE}"><a data-toggle="tab" data-location="{EDITINFO_FORM}/question" href="#edit_question" class="hvr-icon-up"><i class="fa fa-question-circle hvr-icon"></i> {LANG.edit_question}</a></li>
        <!-- END: edit_question -->
        <!-- BEGIN: edit_openid -->
        <li class="{OPENID_ACTIVE}"><a data-toggle="tab" data-location="{EDITINFO_FORM}/openid" href="#edit_openid" class="hvr-icon-up"><i class="fa fa-star hvr-icon"></i> {LANG.openid_administrator}</a></li>
        <!-- END: edit_openid -->
        <!-- BEGIN: edit_group -->
        <li class="{GROUP_ACTIVE}"><a data-toggle="tab" data-location="{EDITINFO_FORM}/group" href="#edit_group" class="hvr-icon-up"><i class="fa fa-users hvr-icon"></i> {LANG.group}</a></li>
        <!-- END: edit_group -->
        <!-- BEGIN: edit_others -->
        <li class="{OTHERS_ACTIVE}"><a data-toggle="tab" data-location="{EDITINFO_FORM}/others" href="#edit_others" class="hvr-icon-up"><i class="fa fa-flag hvr-icon"></i> {LANG.edit_others}</a></li>
        <!-- END: edit_others -->
        <!-- BEGIN: edit_safemode -->
        <li class="{SAFEMODE_ACTIVE}"><a data-toggle="tab" data-location="{EDITINFO_FORM}/safemode" href="#edit_safemode" class="hvr-icon-up"><i class="fa fa-life-buoy hvr-icon"></i> {LANG.safe_mode}</a></li>
        <!-- END: edit_safemode -->
    </ul>
</div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="clearfix radio-box {FIELD.required} {FIELD.class}" data-mess="">
                                    <!-- BEGIN: gender -->
                                    <label class="radio-box"> <input type="radio" name="gender" value="{GENDER.key}" {GENDER.checked} class="{FIELD.class}" onclick="validErrorHidden(this,5);"> {GENDER.title}
                                    </label>
                                    <!-- END: gender -->
                                </div>
                            </div>
        ...
        <div class="page panel  ">
            <div class="panel-body bg-lavender">
                ...
                <form action="{EDITINFO_FORM}/email" method="post" role="form" class="form-horizontal{FORM_HIDDEN}" onsubmit="return changemail_validForm(this);" autocomplete="off" novalidate>
                    ...
                    <div class="form-detail">
                        <div class="form-group">
                            <div class="col-md-6 text-right">{LANG.currentemail}:</div>
                            <div class="col-md-12">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th class="text-center">
                                ...
                                <!-- BEGIN: is_disable_checkbox -->
                                disabled="disabled"
                                <!-- END: is_disable_checkbox -->
                                />
                            </th>
                            <td>
                                <strong>{GROUP_LIST.title}</strong><em class="show text-success">{GROUP_LIST.group_type}</em>
                                <!-- BEGIN: is_leader -->
                            ...
                            <div>
                                <div class="form-group clearfix radio-box {FIELD.required}" data-mess="">
                                    ...
                                    <div class="btn-group col-md-18">
                                        <!-- BEGIN: loop -->
                                        <label for="lb_{FIELD_CHOICES.id}" class="radio-box text-normal"> <input type="radio" name="custom_fields[{FIELD.field}]" value="{FIELD_CHOICES.key}" class="{FIELD.class}" onclick="validErrorHidden(this,5);"{FIELD_CHOICES.checked}> {FIELD_CHOICES.value}
                                        </label>
                                        <!-- END: loop -->
                                    </div>
                                </div>
                        ...
                        <div>
                            <div>
                                <div class="form-group clearfix check-box {FIELD.required}" data-mess="">
                                    ...
                                    <div class="btn-group col-md-18">
                                        <!-- BEGIN: loop -->
                                        <label for="lb_{FIELD_CHOICES.id}" class="check-box text-normal"> <input type="checkbox" name="custom_fields[{FIELD.field}][]" value="{FIELD_CHOICES.key}" class="{FIELD.class}" onclick="validErrorHidden(this,5);"{FIELD_CHOICES.checked}> {FIELD_CHOICES.value}
                                        </label>
                                        <!-- END: loop -->
                                    </div>
                                </div>
