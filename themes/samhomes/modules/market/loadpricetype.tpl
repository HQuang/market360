...
<div class="form-group">
	...
	<div class="col-sm-19 col-md-20 p-tb5 p-lr15">
		<div class="row">
			...
			<div class="col-xs-24 col-sm-11 col-md-11">
				<!-- BEGIN: pricetype_cat_2 -->
				<input class="form-control price required" type="text" name="price" id="price" value="{ROW.price}" placeholder="{LANG.pricetype_cat_title_2_note}" />
				<!-- END: pricetype_cat_2 -->
				<!-- BEGIN: pricetype_cat_1 -->
				<div class="row">
					<div class="col-xs-24 col-sm-12 col-md-12">
						<input class="form-control price required" type="text" name="price" id="price" value="{ROW.price}" placeholder="{LANG.pricetype_cat_from}" />
					</div>
					<div class="col-xs-24 col-sm-12 col-md-12">
			...
			<div class="col-xs-24 col-sm-8 col-md-8">
				<select name="unitid" id="unitid" class="form-control select2b">
