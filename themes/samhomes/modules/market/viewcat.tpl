...
<div id="search_view_mode">
    <div class="row " id="tab_product_index">
        <div class="col-md-12 col-sm-24  col-xs-24 no-padding tab-left m-tb15">
            <div class=" col-xs-8 active text-center">
        ...
        <!-- BEGIN: displays -->
        <div class="col-md-12 col-sm-24 col-xs-24 search-right text-center">
            <div class="m-tb15 d-flex ">
                <span class="lbl visible-lg" style="min-width: 100px; line-height: 34px;">{LANG.displays_product}</span> 
