...
if (defined('NV_IS_FILE_THEMES')) {
    ...
    function nv_block_theme_config_slimmenu($module, $data_block, $lang_block)
    {
        global $nv_Cache;
        $html = '';
    ...
    /**
     * nv_block_theme_config_slimmenu_submit()
     *
     * @param mixed $module
     * @param mixed $lang_block
     * @return
     */
    function nv_block_theme_config_slimmenu_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = array();
        $return['error'] = array();
...
if (defined('NV_SYSTEM')) {
    function nv_theme_slimmenu_blocks($block_config)
    {
        ...
        if (!empty($list_cats)) {
            foreach ($list_cats as $cat) {
                if (empty($cat['parentid'])) {
                    ...
                    $cat['class'] = nv_theme_slimmenu_blocks_active($cat);
    ...
    /**
     * nv_theme_slimmenu_blocks_active()
     *
     * @param mixed $cat
     * @return
     *
     */
    function nv_theme_slimmenu_blocks_active($cat)
    {
        ...
        if (empty($list_sub)) {
            ...
            foreach ($list_cats as $cat) {
                ...
                if (in_array($catid, $list)) {
                    $list_cats[$catid]['class'] = nv_theme_slimmenu_blocks_active($list_cats[$catid]);
    ...
    $content = nv_theme_slimmenu_blocks($block_config);
}
