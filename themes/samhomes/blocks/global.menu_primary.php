...
if (! nv_function_exists('nv_menu_primary')) {
    /**
     ...
     *
     */
    function nv_menu_primary_check_current($url, $type = 0)
    {
     ...
     *
     */
    function nv_menu_primary($block_config)
    {
        global $nv_Cache, $global_config, $site_mods, $module_info, $module_name, $module_file, $module_data, $lang_global, $catid, $home;

        if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks/global.menu_primary.tpl')) {
            $block_theme = $global_config['module_theme'];
        } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/blocks/global.menu_primary.tpl')) {
        ...
        $xtpl = new XTemplate('global.menu_primary.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/blocks');
...
if (defined('NV_SYSTEM')) {
    $content = nv_menu_primary($block_config);
}